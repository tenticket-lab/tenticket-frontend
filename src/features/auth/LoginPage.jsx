...
export default function LoginPage({ onLoggedIn }) {
  ...
  return (
    <div className="min-h-screen relative overflow-hidden bg-gradient-to-br from-sky-200 via-green-100 to-green-300 flex items-center justify-center px-4 py-10">
      ...
      <div className="relative z-10 w-full max-w-md">
        <div className="bg-white/90 backdrop-blur-md rounded-3xl shadow-2xl border border-white/40 overflow-hidden">
          <div className="bg-gradient-to-r from-emerald-700 to-green-600 px-8 py-8 text-white text-center">
